...
{\color{red}\begin{remark}\label{mismatch} Equality does not hold in Theorem~\ref{the:fuzzyderivative}. A counterexample is as follows $\Sigma=\{a,b\}$, $\cR(a,b)=\mu \lneq  1$, then $\mathcal D^\mu_a(a^\star)=(a^\star+b^\star)$. Now  but $ab\notin (a^\star+b^\star)$ but $ab \in \partial_a^\mu(L(r))$. 
\end{remark}}
...
with $0 < \cut \le 1$ such that $\cR^\mu$ is an equivalence.
The following hold. 
\begin{enumerate}
\item  The relation $
...
Let $\cR$ be a fuzzy similarity relation on $\Sigma$ and let $\cut$ be a cut value
with $0 < \cut \le 1$ such that $\cR^\mu$ is an equivalence, moreover let  $\mathcal{L}\subseteq\Sigma^*$ and $a\in\Sigma$. 
\begin{enumerate}
...
Let $\cR$ be a fuzzy similarity relation on $\Sigma$ and let $\cut$ be a cut value
with $0 < \cut \le 1$ such that $\cR^\mu$ is an equivalence.  For every language $L \subseteq \Sigma^*$ and every
$a\in\Sigma$,
\[
  \partial_a^\cut( L)
  \;=\;
