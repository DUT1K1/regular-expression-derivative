...
Viewing words as regular expressions,  Definition~\ref{def:Rw} naturally extends to regular expressions, when the T-norm is locally idempotent on $\mu$ \eg\ if we take G\"odel's T-norm.
