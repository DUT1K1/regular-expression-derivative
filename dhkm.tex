...
\begin{lemma}\label{T-equivalence} The $\mu$-cut of a T-similarity relation, $\cR$ is an equivalence relation if and only if $\otimes$ is locally idempotent on $\mu$, \ie $\mu\otimes\mu=\mu$.
\end{lemma}
