...
\[
\mathcal{R}^r(r_1,r_2)\;\subsetneq\;\mathcal{R}^L\bigl(L(r_1),L(r_2)\bigr).
\]
\end{conjecture}

Clearly equality cannot hold since similarity on regular expresions is defined only up to syntactic equality. {\em E.g.} $\mathcal R^r(a^*,a^*\cdot a^*)=0$. Of course the default clause can be defined differently.
