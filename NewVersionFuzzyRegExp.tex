...
$$\mathcal{R}^E(r,s) = \begin{cases}1 & \mbox{ if } r=s; \\
                                                      ...
                                                      \inf\big (\mathcal{R}^E(r_1,s_1),  \mathcal{R}^E(r_2,s_2) \big )& \mbox{ if } r=r_1+r_2 \mbox{ and } s=s_1+s_2; \\
...
{\color{red}\begin{theorem}\label{thm:Rr-RL-bridge}For all restricted regular expressions $r_1$ and $r_2$,
\begin{enumerate} 
\item $\mathcal R^E(r_1,r_2)\leq \mathcal R^L(L(r_1),L(r_2));$
\item $\mathcal{R}^L\bigl(L(r_1),L(r_2)\bigr)$ is bounded below by:
