...
$$\mathcal{R}^E(r,s) = \begin{cases}1 & \mbox{ if } r=s; \\
                                                      ...
                                                      {\color{blue}\min\!{\big\{\mathcal{R}^E(r_1,s_1),  \mathcal{R}^E(r_2,s_2) \big\}}}& \mbox{ if } r=r_1+r_2 \mbox{ and } s=s_1+s_2; \\
...
\[\mathcal{R}^L\bigl(L(r_1),L(r_2)\bigr)\geq
\sup\Bigl\{\mathcal{R}^E(r_1',r_2')\;\Bigm|\; r_1',r_2' \in R^\Sigma,\; L(r_1')=L(r_1),\;L(r_2')=L(r_2)\Bigr\}.\]}
\end{enumerate}
\end{theorem}
...
{\color{red}Theorem~\ref{thm:Rr-RL-bridge} is not true for  regular expressions when $\wedge$ and $\neg$ are allowed. For instance, if $\mathcal R(a,b)\gneq 0$ but $a\neq b$ we have that $L(a\cap b)=\emptyset$ and hence $\mathcal R^L(L(a\cap a),L(a\cap b))=0$ but $\mathcal R^E(L(a\cap a),L(a\cap b))=\mathcal R(a,b)$. }
