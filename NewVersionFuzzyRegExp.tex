...
\end{cases}$$
\end{definition}
{\color{red} I think that the definition of $\ ^\ast$ is now too strict for a general T-norm. I don't think we can achieve a satisfactory definition for a general T-norm, unless we replace it with a finite union.}
...
\begin{proposition} Let $\alpha \in \mathcal R \mathcal L$, then for all $\mu$, we have $||\alpha ||(a_1\ldots a_n)\geq \mu$  then:
\begin{enumerate} 
\item there exists $\lambda_1,\ldots \lambda_n$ such that  $\lambda_1\otimes  \ldots \otimes \lambda_n\geq \lambda$ and $a_1^{\lambda_1}\ldots a_n^{\lambda_N}\in \mathcal L(r^{\alpha,1})$;
