...
\]
\end{definition}
\paragraph{Notation} Regular expressions, possibly restricted, are denoted by $r,s$ possibly with indices and apexes.  We will write $r[a_1,\ldots,a_n]$ in order to highlight the occurrences of the alphabet symbols $a_1,\ldots,a_n$  in $r$. By $r[s_1,\ldots,s_n]$ we denote the regular expression obtained by replacing $s_1,\ldots,s_n$ in place of $a_1,\ldots, a_n$ in $r[a_1,\ldots,a_n]$.
